...
Use the SSI Service to set up a Presentation Definition and corresponding Presentation Request to accept a KYC credential. We have the prerequisites for this in our [credential_manifest integration test](https://github.com/extrimian/ssi-service/blob/main/integration/credential_manifest_integration_test.go)
